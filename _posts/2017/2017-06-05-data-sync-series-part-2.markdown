...
For the exercise that I outlined in my [previous post]( __GHOST_URL__ /data-sync-series-part-1/), I’ll be using an asynchronous peer-to-peer model. I think that this model is ideal for iOS (and other mobile) clients. This allows for the most flexibility in a (still) questionably connected world.
...
[Part 1]( __GHOST_URL__ /data-sync-series-part-1/) | [Part 3]( __GHOST_URL__ /data-sync-series-part-3/) | [Part 4]( __GHOST_URL__ /data-sync-series-part-4/) | [Part 5]( __GHOST_URL__ /data-sync-series-part-5/)
